...
class EntityId(ValueObject):
    ...
    Each identity carries a ``last_id`` reference to the previous identity,
    ...
    def evolve(self, **changes: Any) -> Self:
        ...
        If this identity already has a ``last_id``, the new identity inherits
